...
<form action="" method="post">
    <section>
        ...
        <input type="text" name="srv-titulo" id="lbl-titulo">
    </section>
    <section>
        <label for="lbl-desc">Descripcion:</label>
        <textarea name="srv-descripcion" id="lbl-desc" cols="30" rows="10"></textarea>
    </section>
    <section>
        <label for="lbl-precio">Precio</label>
        <input type="number" step="0.01" name="srv-precio" id="lbl-precio">
    </section>
